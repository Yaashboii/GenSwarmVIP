tasks = {
    ...
    "explore": "Robots need to collaborate to explore the entire map area. Divide the map into several regions equal to the number of robots."
...
def get_user_commands(task_name: str | list = None) -> list[str]:
    ...
    Args:
        ...
        options are ["flocking", "cover", "explore", "pursuit", "cross", "formation",None]
