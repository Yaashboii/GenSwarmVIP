...
class MoveFormationEnvironment(EnvironmentBase):
    def __init__(self,
                 width: int,
                 height: int,
                 robot_num: int,
    ...
    def init_entities(self):
        ...
        obstacle_points = self.sample_points_inside_circle(450, (500, 500), self.obstacle_num, 100)
        for entity_id, initial_position in enumerate(obstacle_points, start=self.robot_num):
