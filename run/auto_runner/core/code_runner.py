...
class CodeRunner:
    def __init__(self, time_out, target_pkl, script_name, feedback, experiment_path: str, env_manager=None,
                 test_mode=None):
    ...
    def load_run_result(self, experiment_id, result_type):
        ...
        for run_mode in ['global', 'local', 'init']:
            file_path = os.path.join(experiment_path, f'{result_type}_{run_mode}_run.json')
